           ...
           <div className='post'>
               <div className='user'>
                   <div className='img-wrapper'>
                     <img src='https://images.unsplash.com/photo-1768489038932-a63eef1fe51f?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw1NXx8fGVufDB8fHx8fA%3D%3D' alt=''/>
                   </div>
                  <p>username</p>
               </div>
             <img src='https://images.unsplash.com/photo-1516195851888-6f1a981a862e?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Z2lybHN8ZW58MHx8MHx8fDA%3D' alt=''/>
                <div className='icons'>
                    <div className='left'>
